...
def download_reports(keys):
    ...
    #for (key, value) in all_bk.items():
        ...
        mysheet["E{}".format(current_line)] = "年增持"
        mysheet["F{}".format(current_line)] = "季增持"
        mysheet["G{}".format(current_line)] = "月增持"
        mysheet["H{}".format(current_line)] = "10日"
        mysheet["I{}".format(current_line)] = "5日"
        mysheet["J{}".format(current_line)] = "3日"
        mysheet["K{}".format(current_line)] = "1日"
        mysheet["L{}".format(current_line)] = "行业"
        ...
        for (key, value) in bk_items.items():
            ...
            mysheet["E{}".format(current_line)] = value.setdefault("y", '000000')
            mysheet["F{}".format(current_line)] = value.setdefault("jd", '000000')
            mysheet["G{}".format(current_line)] = value.setdefault("m", '000000')
            mysheet["H{}".format(current_line)] = value.setdefault("10", '000000')
            mysheet["I{}".format(current_line)] = value.setdefault("5", '000000')
            mysheet["J{}".format(current_line)] = value.setdefault("3", '000000')
            mysheet["K{}".format(current_line)] = value.setdefault("1", '000000')
            mysheet["L{}".format(current_line)] = bk_name
        try:
